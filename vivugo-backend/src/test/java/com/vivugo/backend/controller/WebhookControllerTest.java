...
class WebhookControllerTest {
    ...
    void handlesRawJsonWebhookPayloadWithoutTransferType() {
        ...
        ResponseEntity<Map<String, Object>> response = controller.handleSeepayRawWebhook(rawJson.getBytes());
    ...
    private WebhookController controller(BookingService bookingService) {
        return new WebhookController(bookingService, new ObjectMapper());
    }
}
